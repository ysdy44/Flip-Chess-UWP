...
namespace Flip_Chess.Chesses.AutoAIs
{
    ...
    {
        public int Level;
        public readonly BlackAutoAI[] Children;
        ...
        public BlackAutoAICollection(IIndexer indexer)
        {
            ...
            // 3. Children
            var historion = indexer.Collection.GetBlackHistory(0).ToArray();
            ...
            for (int i = 0; i < historion.Length; i++)
            {
                ...
                this.Children[i] = new BlackAutoAI(indexer, item, 0, indexer.Step);
            }
